...
Utlizing variables I created alarm parameters. Then simple if, elif, else statements along with f-strings to achieve the desired output based off the patient vital sign readings.
